...
#ifndef MIMECONVERTER_H_
#define MIMECONVERTER_H_

#define SIZE_MIMETL 447

struct
{
	char extension[15];
	char mimetype[100];
} mimeTypesListing[SIZE_MIMETL] = {
	{".3dm",	   "x-world/x-3dmf"},
	{".3dmf",	   "x-world/x-3dmf"},
...
extern "C" __declspec(dllexport) void convertFileToMime(const wchar_t* wFileName, int em);
extern "C" __declspec(dllexport) void convertMimeToFile(const wchar_t* wFileNameMIME, int em);
